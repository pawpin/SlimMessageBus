...
namespace SlimMessageBus.Host.AzureEventHub
{
    ...
    public class EventHubMessageBus : MessageBusBase
    {
        ...
        private readonly SafeDictionaryWrapper<string, EventHubClient> _producerByTopic = new SafeDictionaryWrapper<string, EventHubClient>(); 
            ...
            : base(settings)
        {
            ...
            _producerByTopic.ValueFactory = topic =>
            {
        ...
        protected override void OnDispose()
        {
            ...
            {
                foreach (var producer in _producerByTopic.Dictonary.Values)
                {
